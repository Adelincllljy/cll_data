    ...
    @thread_number.times do 
      thread = Thread.new do
        loop do
          ...
          #   puts "==="
          #   info.test_density=item.gh_test_cases_per_kloc
          #   info.assert_density=item.gh_asserts_cases_per_kloc
          #   info.sloc_flag=1
          #   info.save
          #   i=1
          #   break
...
# repo_path = "/Users/zhangchen/projects/autofix"
# commit_sha = "39b65a6e591ceb801aced2db28fc784a1146607c"
# commit_sha1 = "39b6ss6e591ceb801aced2db28fc784a1146607c"#不存在的commit，输出nil

# repo = ExtractGitInfo.new(repo_path)

# p repo.gh_test_cases_per_kloc(commit_sha1)
# p repo.gh_asserts_cases_per_kloc(commit_sha)